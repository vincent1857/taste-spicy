...
package cn.vincent.taste.spicy.rpc.webservice.context;
...
public class WebServiceContext {
    ...
    private static ThreadLocal<WebServiceContext> contextThreadLocal = new ThreadLocal<>();
     ...
     * @return 上下文对象
     */
    public static WebServiceContext getContext() {
        WebServiceContext ctx = contextThreadLocal.get();
        if (ctx == null) {
